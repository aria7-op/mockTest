    ...
    <div className="admin-layout flex h-screen">
      ...
      >
        ...
        <div style={{ background: 'var(--secondary-100)', height: '100%', overflowY: 'auto', padding: '24px' }}>
          ...
          {!notificationsLoading && Array.isArray(notifications) && notifications.map((notification) => {
            ...
            return (
              ...
              >
                <div style={{ 
                  ...
                  <IconComponent style={{ color: 'white', fontSize: '1rem' }} />
                </div>
                <div style={{ flex: 1 }}>
                  <div style={{ 
                  ...
                  <div style={{ fontSize: '0.875rem', color: 'var(--secondary-500)', marginBottom: '4px' }}>
                    {notification.message || notification.content || getNotificationMessage(notification.type)}
                  </div>
