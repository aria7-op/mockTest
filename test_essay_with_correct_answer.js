...
async function testEssayWithCorrectAnswer() {
  try {
    ...
    for (const question of questions) {
      ...
      if (question.type === 'ESSAY') {
        ...
        if (correctOption) {
          ...
          console.log(`   ✅ Using correct answer from DB: ${essayAnswer.substring(0, 100)}...`);
          ...
          console.log(`   ❌ No correct answer found in DB`);
